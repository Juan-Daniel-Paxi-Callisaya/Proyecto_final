...
<section class="container">
	<div class="centrar"><h1>TAREAS</h1></div>	
	<hr>	
<%@include file="opciones.jsp" %>
<input name="area" type="hidden" value="tareas" />
	<div class="col-md-offset-1 col-md-5">
		<h3>Nueva Tarea</h3>
		<form action="Controlador_docentes" method="get">
                <input type="hidden" name="area_docente" value="tareas" />
	...
	<div class="col-md-offset-0 col-md-5">
		...
		<form action="Controlador_estudiantes" method="get">
                <input type="hidden" name="area_estudiante" value="tareas" />
		...
		<input type="number" name="monto_estudiante" class="form-control" placeholder="Ingresar monto">
